...
(function (global, factory) {
          ...
          then: function (onFulfilled, onRejected, onProgress) {
            ...
            return jQuery
              .Deferred(function (newDefer) {
                ...
                tuples[0][3].add(
                  resolve(0, newDefer, typeof onProgress === "function" ? onProgress : Identity, newDefer.notifyWith)
                );
  ...
  function adjustCSS(elem, prop, valueParts, tween) {
    var adjusted,
      ...
      initialInUnit =
        elem.nodeType && (!isAutoPx(prop) || (unit !== "px" && +initial)) && rcssNum.exec(jQuery.css(elem, prop));
  ...
  function computeTableStyleTests() {
    ...
    reliableTrDimensionsVal =
      Math.round(
        parseFloat(trStyle.height) + parseFloat(trStyle.borderTopWidth) + parseFloat(trStyle.borderBottomWidth)
      ) === tr.offsetHeight;
